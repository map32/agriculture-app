...
export const getCurrentWeather = async (nx: number | string, ny: number | string, date?: Date) => {
    ...
    const baseTimesAvailable = ['0010', '0110', '0210', '0310', '0410', '0510', '0610', '0710', '0810', '0910', '1010', '1110', '1210', '1310', '1410', '1510', '1610', '1710', '1810', '1910', '2010', '2110', '2210', '2310']
    ...
    try {
        ...
        items.forEach((val, ind) => {
            if (!structuredItems[val.baseDate]) {
                structuredItems[val.baseDate] = {};
            }
            if (!structuredItems[val.baseDate][val.baseTime]) {
                structuredItems[val.baseDate][val.baseTime] = {};
            }
